...
alpha_yaw 	= np.load(alpha_dir + 'a_yaw.npy')

alpha_x_cos_y 	  = np.load(alpha_dir + 'a_x_cos_y.npy')
alpha_x_sin_y 	  = np.load(alpha_dir + 'a_x_sin_y.npy')
alpha_x_cos_z 	  = np.load(alpha_dir + 'a_x_cos_z.npy')
alpha_x_sin_z 	  = np.load(alpha_dir + 'a_x_sin_z.npy')
alpha_x_cos_sin_y = np.load(alpha_dir + 'a_x_cos_sin_y.npy')


alpha_sin_x_y 	  = np.load(alpha_dir + 'a_sin_x_y.npy')
alpha_cos_x_y 	  = np.load(alpha_dir + 'a_cos_x_y.npy')
alpha_y_cos_z 	  = np.load(alpha_dir + 'a_y_cos_z.npy')
alpha_y_sin_z 	  = np.load(alpha_dir + 'a_y_sin_z.npy')
alpha_cos_sin_x_y = np.load(alpha_dir + 'a_cos_sin_x_y.npy')

alpha_rand_x_y = np.load(alpha_dir + 'a_rand_x_y.npy')
alpha_x_rand_y = np.load(alpha_dir + 'a_x_rand_y.npy')
alpha_rand_x_neg_y = np.load(alpha_dir + 'a_rand_x_neg_y.npy')
alpha_rand_neg_x_y = np.load(alpha_dir + 'a_rand_neg_x_y.npy')
alpha_test_traj_1 = np.load(alpha_dir + 'a_test_traj_1.npy')

alpha_circle = np.load(alpha_dir + 'a_circle.npy')
